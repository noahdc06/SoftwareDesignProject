    ...
    public CreateProfilePage(HomePage homePage) {
        ...
        createButton.addActionListener(e -> {
            ...
            if (username.isEmpty() || password.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Username and password are required.");//basic input validation
                return;
            }
            ...
            try {
                ...
                if (userDAO.usernameExists(username)) {
                    JOptionPane.showMessageDialog(this, "That username already exists.");//prevent duplicate usernames
                    return;
                }

                Profile profile = userDAO.createUser(username, password);
                SessionManager.getInstance().setCurrentProfile(profile);//set created profile to active
